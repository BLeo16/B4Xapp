...
user.myClass = BA.getDeviceClass ("b4a.example.user");
post.myClass = BA.getDeviceClass ("b4a.example.post");
users.myClass = BA.getDeviceClass ("b4a.example.users");
posts.myClass = BA.getDeviceClass ("b4a.example.posts");
postpage.myClass = BA.getDeviceClass ("b4a.example.postpage");
